...
class MyApp:
    def __init__(self):
        ...
        self.style.configure("TFrame", background="#e0e0e0", foreground="white")
        self.root.geometry("1000x600")
        self.root.title("Lab 5")
        ...
        self.btn_liang = Button(self.algorithm_row, text="Liang-Barsky Algorithm", command=self.draw_liang, width=30,
                                bg="#1bcade",
                                font=("Arial", 12, "bold"), foreground="#FFFFFF")
        self.btn_liang.pack(side="top", pady=12)

        self.btn_cyrus = Button(self.algorithm_row, text="Cyrus-Beck Algorithm", command=self.draw_cyrusa, width=30,
                                bg="#1bcade",
                                font=("Arial", 12, "bold"), foreground="#FFFFFF")
